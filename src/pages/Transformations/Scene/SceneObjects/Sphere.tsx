...
import { sphereAnimationStoreApi } from './animationStores';
...
const Sphere = React.memo(function Sphere({ modelColor, objectData }: Props) {
  ...
  useAnimations(objectData.transformations, ref, sphereAnimationStoreApi);
  ...
  useEffect(() => {
    if (state.activeObject.reset) {
      ...
      ref.current.geometry = new THREE.SphereGeometry(1, 8, 8);
    }
